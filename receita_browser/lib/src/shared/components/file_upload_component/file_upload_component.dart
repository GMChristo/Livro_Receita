...
// import 'package:receita_browser/src/shared/utils/utils.dart';
...
//       'Nenhum arquivo carregado ainda.'; //"No file uploaded yet."
...
//   String get currentSizeInMegabytesStr =>
//       (currentSizeInBytes / (1024 * 1024)).toStringAsFixed(2);
...
//   // StreamController<FormularioAnexo> onChangeStreamController =
//   //     StreamController<FormularioAnexo>();
