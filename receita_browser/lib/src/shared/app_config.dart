...
class AppConfig {
  ...
  String basePath = '/visitacao_server/api/v1';
  String port = (html.window.location.protocol.startsWith('https:') ? 443 : 80)
      .toString();
  String get _currentToken =>
      html.window.sessionStorage.containsKey('YWNjZXNzX3Rva2Vu')
  ...
  AppConfig() {
    ...
    if (html.window.location.host.contains('10.0.0.72')) {
      ...
      port = '86';
      domain = '10.0.0.72:';
      basePath = '/visitacao_server/api/v1';
    }
  }
  ...
  String get serverURL =>
      protocol + '//' + subdomain + domain + port + basePath;
}
